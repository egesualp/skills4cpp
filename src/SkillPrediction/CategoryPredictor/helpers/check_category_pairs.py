...
from src.SkillPrediction.CategoryPredictor.category_trainer import (
    load_esco_data,
...
def main():
    ...
    from src.SkillPrediction.CategoryPredictor.category_trainer import stratified_split_occupations
