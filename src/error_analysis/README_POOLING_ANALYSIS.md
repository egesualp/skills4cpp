...
If you use this analysis in your research, please cite the thesis work on Career Path Prediction with skill-based representations.

---

## Contact

For questions or issues, contact the thesis author.
