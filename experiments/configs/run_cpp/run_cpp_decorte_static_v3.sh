...
OUTPUT_BASE="/dss/dssmcmlfs01/pr74ze/pr74ze-dss-0001/ra95kix2/results/cpp/decorte_static_v3"
WANDB_PROJECT="cpp-decorte-static-v3-final"
...
python -m src.cpp.train_cpp_enhanced_v3 \
    --data_type $DATA_TYPE \
    --encoder_text $ENCODER_TEXT \
    --output_dir "${OUTPUT_BASE}/job_titles_skills_gte_desc_optuna" \
    --run_name "job_titles_skills_gte_desc_optuna" \
    --use_text_history \
    --use_skill_text \
    --use_text_description \
    --use_skill_description \
