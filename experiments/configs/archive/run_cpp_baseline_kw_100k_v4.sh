...
python -m src.cpp.train_cpp_enhanced_v3 \
    ...
    --output_dir results/cpp/kw_esco_100k_v4_last_job_skills_wo_desc \
    --use_text_history \
    --use_text_description \
    --use_skill_text \
    --use_advanced \
    --run_name kw_esco_100k_v4_last_job_skills_wo_desc \
    --use_wandb \
    --wandb_project "cpp-kw-esco-100k-last-job-skills" \
    --optuna \
    --n_trials 10 \
    --patience 3 \
    --optimizer adam \
